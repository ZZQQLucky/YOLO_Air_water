...
def parse_opt():
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/v5lite-s+Shuffle+GSConv+ShuffleAttention+Decoupled+QFocal_100_0.98扩充/weight/best.pt', help='weights path')
